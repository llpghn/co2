...
#    if defined(__arm__)
#     define SYS_getrandom    (__NR_SYSCALL_BASE+384)
#    elif defined(__i386__)
#     define SYS_getrandom    355
#    elif defined(__x86_64__)
#     if defined(__ILP32__)
#      define SYS_getrandom   (__X32_SYSCALL_BIT + 318)
#     else
...
#     define SYS_getrandom    389
#    elif defined(__powerpc__)
#     define SYS_getrandom    359
#    elif defined(__mips__) || defined(__mips64)
#     if _MIPS_SIM == _MIPS_SIM_ABI32
#      define SYS_getrandom   (__NR_Linux + 353)
#     elif _MIPS_SIM == _MIPS_SIM_ABI64
#      define SYS_getrandom   (__NR_Linux + 313)
#     elif _MIPS_SIM == _MIPS_SIM_NABI32
#      define SYS_getrandom   (__NR_Linux + 317)
#     endif
#    elif defined(__hppa__)
#     define SYS_getrandom    (__NR_Linux + 339)
#    elif defined(__sparc__)
#     define SYS_getrandom    347
#    elif defined(__ia64__)
#     define SYS_getrandom    1339
